...
function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("http://localhost:5187/api/Auth/Login", formData);
      ...
      <div className="formulario" >
        ...
        <form method="post" onSubmit={handleSubmit}>
          ...
          <div className="nombreUsuario">
            <input name="nombreUsuario" type="text" required onChange={handleChange} value={formData.nombreUsuario}></input>
            <label>Nombre de Usuario</label>
          </div>

          {/** Input de la contraseña*/}
          <div className="nombreUsuario">
            <input name="contrasena" type="password" required onChange={handleChange} value={formData.contrasena}></input>
