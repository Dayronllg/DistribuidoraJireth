...
const initialRows: FilaProveedores[] = [
  { ruc: 1, nombre: "Jon", telefono: "9063-9012" },
  { ruc: 2, nombre: "Cersei", telefono: "8439-1045" },
  { ruc: 3, nombre: "Jaime", telefono: "4298-5134" },
  { ruc: 4, nombre: "Arya", telefono: "3589-4126" },
  { ruc: 5, nombre: "Daenerys", telefono: "9318-6312" },
];
