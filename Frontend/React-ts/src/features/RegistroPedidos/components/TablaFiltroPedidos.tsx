      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        ...
        <tbody>
          {paginatedRows.length > 0 ? (
            paginatedRows.map((row) => (
              ...
              >
                ...
                <td style={tdStyle}>
                  <button
                    onClick={() =>
                      toast.success(`Pedido ID: ${row.idPedido} cancelado`)
                    }
                    style={{
                    ...
                    onMouseEnter={
                      (e) => (e.currentTarget.style.backgroundColor = "#bb2d3b") // hover color
                    }
                    onMouseLeave={
                      (e) => (e.currentTarget.style.backgroundColor = "#dc3545") // original color
                    }
                  >
                    Cancelar
                  </button>
            ...
            <tr>
              <td colSpan={7} style={tdStyle} align="center">
